...
\begin{algorithmic}[1]
\Function{EnOpt}{$\textproc{F},\mathbf{q}_0,N,\varepsilon,k^*,\beta_1,\beta_2,r,\nu^*,\sigma^2,\rho, N_t, N_b, \textproc{pr} \gets \mathbf{lambda}\:\mathrm{mu}: \mathrm{mu}, $\par$\mathbf{C}_\mathrm{init}\gets\mathrm{None}$}
...
\For{$i\gets0,\dotsc,N_\mathbf{q}-1$}
