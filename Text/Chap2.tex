...
\begin{equation}
\label{definitionAnalyticalSmallJ}
j(q):=J(q,u(q)).
\end{equation}
...
\end{equation}
which is solved after $\mathbf{U}_m$ with algorithms from the Python package SciPy \cite{2020SciPy-NMeth}.
